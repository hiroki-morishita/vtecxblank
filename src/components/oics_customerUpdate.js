...
export default class CustomerUpdate extends React.Component {
	...
	handleSubmit(e: InputEvent) {
		...
		entry.customer = {
								   customer_number: this.entry.customer.customer_number,											//顧客コード
								    corporate_type: this.entry.customer.corporate_type ? this.entry.customer.corporate_type : '',	//顧客区分
								  ...
								  person_in_charge:   e.target.person_in_charge.value ? e.target.person_in_charge.value : '',	//担当社員
			                        ...
			                        birthday_month:     e.target.birthday_month.value ? e.target.birthday_month.value : '',		//誕生月
									  birthday_day:       e.target.birthday_day.value ? e.target.birthday_day.value : '',		//誕生日
								               ...
								               sex:           this.entry.customer.sex ? this.entry.customer.sex : '',			//性別
		...
		entry.account_info = {
						      billing_closing_date:    e.target.billing_closing_date.value ? e.target.billing_closing_date.value : '',		//請求締日
							       date_of_payment:         e.target.date_of_payment.value ? e.target.date_of_payment.value : '',			//支払日
								     payment_month:  this.entry.account_info.payment_month ? this.entry.account_info.payment_month : '',	//支払月区分
			                        payment_method: this.entry.account_info.payment_method ? this.entry.account_info.payment_method : '',	//支払い方法
								...
								<Panel collapsible header="顧客情報" eventKey="1" bsStyle="info" defaultExpanded="true">
									...
									<FormGroup>
										...
										<Col xs={2} sm={2} md={2} lg={2} xl={2}>
											<ControlLabel class="text-right">顧客コード</ControlLabel>
										</Col>
										<Col xs={3}sm={3}md={3}lg={3}xl={3}>
											<h3>{this.entry.customer.customer_number}</h3>
										</Col>
